...
/// @nodoc
abstract class $BaseStatesCopyWith<T, $Res> {
  factory $BaseStatesCopyWith(
          BaseStates<T> value, $Res Function(BaseStates<T>) then) =
      _$BaseStatesCopyWithImpl<T, $Res, BaseStates<T>>;
}

/// @nodoc
class _$BaseStatesCopyWithImpl<T, $Res, $Val extends BaseStates<T>>
    implements $BaseStatesCopyWith<T, $Res> {
  _$BaseStatesCopyWithImpl(this._value, this._then);
...
class __$$InitialStateImplCopyWithImpl<T, $Res>
    extends _$BaseStatesCopyWithImpl<T, $Res, _$InitialStateImpl<T>>
...
abstract class InitialState<T> implements BaseStates<T> {
...
class __$$LoadingStateImplCopyWithImpl<T, $Res>
    extends _$BaseStatesCopyWithImpl<T, $Res, _$LoadingStateImpl<T>>
...
abstract class LoadingState<T> implements BaseStates<T> {
...
class __$$SuccessStateImplCopyWithImpl<T, $Res>
    extends _$BaseStatesCopyWithImpl<T, $Res, _$SuccessStateImpl<T>>
...
class _$SuccessStateImpl<T> implements SuccessState<T> {
  ...
  @override
  String toString() {
    return 'BaseStates<$T>.success(data: $data)';
  }
...
abstract class SuccessState<T> implements BaseStates<T> {
...
class __$$ErrorStateImplCopyWithImpl<T, $Res>
    extends _$BaseStatesCopyWithImpl<T, $Res, _$ErrorStateImpl<T>>
...
abstract class ErrorState<T> implements BaseStates<T> {
  const factory ErrorState(final String? error) = _$ErrorStateImpl<T>;
