...
import '../../Features/exams/data/data_sources/local_data_source/exam_local_data_base.dart'
    as _i486;
import '../../Features/exams/data/data_sources/local_data_source/exam_local_data_base_contract.dart'
    as _i471;
...
import '../../Features/exams/data/data_sources/remote_data_source/exam_remote_data_source_impl.dart'
    as _i583;
import '../../Features/exams/data/repositories/exam_local_repository_impl.dart'
    as _i589;
import '../../Features/exams/data/repositories/exam_repo_impl.dart' as _i846;
import '../../Features/exams/domain/repositories/exam_local_repository.dart'
    as _i309;
...
import '../../Features/exams/domain/use_cases/exam_quetions_use_case.dart'
    as _i590;
import '../../Features/exams/domain/use_cases/get_exams_on_subject_use_case.dart'
    as _i62;
...
import '../../Features/user_profile/data/data_sources/remote_data_source/user_profile_remote_data_source.dart'
    as _i271;
import '../../Features/user_profile/data/data_sources/remote_data_source/user_profile_remote_data_source_impl.dart'
    as _i403;
...
import '../../Features/user_profile/presentation/manager/profile_view_model_cubit.dart'
    as _i604;
import '../../Features/user_results/presentation/manager/user_view_model_cubit.dart'
    as _i158;
import '../app_manger/app_local_storage/app_local_storage.dart' as _i841;
import '../app_manger/app_local_storage/app_local_storage_impl.dart' as _i977;
import '../app_manger/app_manger.dart' as _i911;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i471.ExamLocalDataBaseContract>(
        () => _i486.ExamLocalDataSource());
    gh.factory<_i898.HomRemoteDataSourceContract>(
        () => _i250.HomeTabRemoteImpl());
    gh.factory<_i841.AppLocalStorage>(() => _i977.AppLocalStorageImpl());
    gh.lazySingleton<_i309.ExamLocalRepository>(() =>
        _i589.ExamLocalRepositoryImpl(gh<_i471.ExamLocalDataBaseContract>()));
    gh.singleton<_i48.AuthInterceptor>(
        () => dioModule.provideAuthInterceptor(gh<_i841.AppLocalStorage>()));
    ...
    gh.singleton<_i911.AppManger>(
        () => _i911.AppManger(gh<_i841.AppLocalStorage>()));
    gh.factory<_i158.UserViewModelCubit>(
        () => _i158.UserViewModelCubit(gh<_i309.ExamLocalRepository>()));
    ...
    gh.factory<_i996.HomeCubit>(
        () => _i996.HomeCubit(gh<_i174.GetAllSubjectsUseCase>()));
    ...
    gh.factory<_i271.UserProfileRemoteDataSource>(
        () => _i403.UserProfileRemoteDataSourceImpl(gh<_i460.WebServices>()));
    ...
    gh.factory<_i464.UserProfileRepo>(() => _i242.UserProfileRepoImpl(
        userProfileRemoteDataSource: gh<_i271.UserProfileRemoteDataSource>()));
    ...
    gh.factory<_i62.GetExamsOnSubjectUseCase>(
        () => _i62.GetExamsOnSubjectUseCase(gh<_i334.ExamRepo>()));
    ...
    gh.factory<_i337.ExamViewModel>(() => _i337.ExamViewModel(
          ...
          gh<_i309.ExamLocalRepository>(),
          gh<_i345.CheckUserAnswersUseCase>(),
          gh<_i62.GetExamsOnSubjectUseCase>(),
        ));
