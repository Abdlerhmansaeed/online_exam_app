...
import '../../Features/user_profile/presentation/manager/profile_view_model_cubit.dart'
    as _i604;
import '../../Features/user_results/data/data_sources/user_results_data_source.dart'
    as _i183;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i486.ExamLocalDataSource>(
    ...
    gh.factory<_i183.UserResultsDataSource>(
        () => _i183.UserResultsDataSource(gh<_i486.ExamLocalDataSource>()));
    ...
    gh.factory<_i158.UserViewModelCubit>(
        () => _i158.UserViewModelCubit(gh<_i183.UserResultsDataSource>()));
