...
class _WebServices implements WebServices {
  ...
  @override
  Future<RegisterResponse> login(LoginRequest data) async {
  ...
  @override
  Future<RegisterResponse> signup(SignUpRequest data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<ResetPasswordVerify> forgetPasswordEmailVerify(
      ForgetPasswordEmailRequest data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(data.toJson());
    final _options = _setStreamType<ResetPasswordVerify>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ResetPasswordVerify _value;
    try {
      _value = ResetPasswordVerify.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<OtpCodeResponse> resetCodeVerify(OtpCodeVerifyRequset data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<GetExamsOnSubject> getExamsOnSubject(String subjectId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetExamsOnSubject _value;
    try {
      _value = GetExamsOnSubject.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
