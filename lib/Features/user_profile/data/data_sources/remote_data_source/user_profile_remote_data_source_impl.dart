...
class UserProfileRemoteDataSourceImpl implements UserProfileRemoteDataSource {
  ...
  Future<ApiResult<ChangePasswordResponse>> changePassword(
    ...
    var response = _webServices.changePassword(data);
    return RetrofitHandler.handle(() => response);
  }

  @override
  Future<ApiResult<EditProfileResponse>> editUserProfile(
      EditProfileRequest data) {
    var response = _webServices.editUserDetails(data);
    return RetrofitHandler.handle(() => response);
  }

  @override
  Future<ApiResult<GetUserProfileResponse>> getUserDetails() {
    var response = _webServices.getUserDetails();
    return RetrofitHandler.handle(() => response);
  }
}
