...
class _HomeScreenState extends State<HomeScreen> {
  HomeCubit homeCubit = HomeCubit(getIt<GetAllSubjectsUseCase>(),
      getIt<GetExamsOnSubjectUseCase>());
  @override
            ...
            builder: (context, state) {
              ...
              return state is HomeSuccessState
                  ? Expanded(
                      ...
                      return InkWell(
                        onTap: () => 
                        Navigator.pushNamed(context, AppRoutes.subjectDetails,arguments: state.subjectsEntity[index].id??''),
                        child: SubjectAndExamItem(
                          imageUrl: state.subjectsEntity[index].icon??'',
